package com.selectica.CanSee.definitions.CNDABO.CNDADetails.scripts;

import com.selectica.CanSee.eclm.definitions.CNDABO.CNDADetails.scripts.OnSaveTrigger;
