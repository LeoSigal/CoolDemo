package com.selectica.CanSee.eclm.definitions.RREPBO.RRepDetails.scripts;

import com.selectica.CanSee.eclm.definitions.DirectoryStatus;
import com.selectica.CanSee.eclm.definitions.RepositoryStatus;
import com.selectica.CanSee.stubs.DirectoryInfoComponent;
import com.selectica.CanSee.stubs.RRepDetails;
...
public class OnCreateTrigger extends AbstractDataWriteScript<Boolean> {
    ...
    public Boolean process() throws Exception {
        ...
        details.setContractState("Exisiting");
        return true;
    }
}
